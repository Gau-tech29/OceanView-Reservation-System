  ...
  <table class="table table-bordered">
    ...
    <c:if test="${reservation.discountAmount != null && reservation.discountAmount > 0}">
      <tr>
        ...
        <td class="text-end text-success">-$<fmt:formatNumber value="${reservation.discountAmount}" pattern="#,##0.00"/></td>
      </tr>
    </c:if>
    <tr class="total-row table-light">
      <td colspan="3" class="text-end">TOTAL AMOUNT</td>
      <td class="text-end total-amount">$<fmt:formatNumber value="${reservation.totalAmount}" pattern="#,##0.00"/></td>
    </tr>
    </tbody>
  </table>
