...
<div class="main-content">
    ...
    <div class="search-box">
        <input type="text" id="searchInput" placeholder="Search by reservation number, guest name, or room number..."
               value="${param.search}">
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="btn-group" role="group">
                                ...
                                <% if(isAdmin) { %>
                                <a href="${pageContext.request.contextPath}/admin/reservations/delete?id=${res.id}"
        ...
        <nav aria-label="Page navigation">
            <ul class="pagination">
                <li class="page-item ${currentPage == 1 ? 'disabled' : ''}">
                    <a class="page-link" href="?page=${currentPage - 1}&size=10" tabindex="-1">Previous</a>
                </li>
...
<script>
    ...
    function searchReservations() {
        ...
        window.location.href = '${pageContext.request.contextPath}<%= basePath %>/reservations/search?searchValue=' + encodeURIComponent(searchValue);
    }
